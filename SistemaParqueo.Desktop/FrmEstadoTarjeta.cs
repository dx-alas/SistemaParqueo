...
{
    public partial class FrmEstadoTarjeta : Form
    {
        public FrmEstadoTarjeta()
        {
            InitializeComponent();
            this.Load += FrmEstadoTarjeta_Load;
            dgvEstado.CellClick += dgvEstado_CellClick;
        }

        private void FrmEstadoTarjeta_Load(object sender, EventArgs e)
        {
            txtId.ReadOnly = true;
            ConfigurarGrid();
            CargarDatos();
        ...
        private void CargarDatos()
        {
            try
            {
                var data = EstadoTarjetaBL.Instance.SelectAll();
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                bool ok = EstadoTarjetaBL.Instance.Insert(entity);
        ...
        private void btnActualizar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                EstadoTarjeta entity = new EstadoTarjeta
                {
                    EstadoTarjetaId = Convert.ToInt32(txtId.Text),
                    Nombre = txtNombre.Text.Trim()
                };

                bool ok = EstadoTarjetaBL.Instance.Update(entity);
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                bool ok = EstadoTarjetaBL.Instance.Delete(id);
