...
{
    public partial class FrmEstadoEmpleado : Form
    {
        public FrmEstadoEmpleado()
        {
            InitializeComponent();
            this.Load += FrmEstadoEmpleado_Load;
            dgvEstado.CellClick += dgvEstado_CellClick;
        }

        private void FrmEstadoEmpleado_Load(object sender, EventArgs e)
        {
            txtId.ReadOnly = true;
            ConfigurarGrid();
            CargarDatos();
        ...
        private void CargarDatos()
        {
            try
            {
                var data = EstadoEmpleadoBL.Instance.SelectAll();
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                bool ok = EstadoEmpleadoBL.Instance.Insert(entity);
        ...
        private void btnActualizar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                EstadoEmpleado entity = new EstadoEmpleado
                {
                    EstadoEmpleadoId = Convert.ToInt32(txtId.Text),
                    Nombre = txtNombre.Text.Trim()
                };

                bool ok = EstadoEmpleadoBL.Instance.Update(entity);
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                bool ok = EstadoEmpleadoBL.Instance.Delete(id);
