...
namespace SistemaParqueo.Desktop
{
    public partial class FrmEstadoCliente : Form
    {
        ...
        private void CargarDatos()
        {
            try
            {
                var data = EstadoClienteBL.Instance.SelectAll();
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                bool ok = EstadoClienteBL.Instance.Insert(entity);
        ...
        private void btnActualizar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                EstadoCliente entity = new EstadoCliente
                {
                    EstadoClienteId = Convert.ToInt32(txtId.Text),
                    Nombre = txtNombre.Text.Trim()
                };

                bool ok = EstadoClienteBL.Instance.Update(entity);
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                bool ok = EstadoClienteBL.Instance.Delete(id);
