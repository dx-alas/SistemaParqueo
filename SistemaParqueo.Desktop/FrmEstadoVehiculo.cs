...
{
    public partial class FrmEstadoVehiculo : Form, IFormularioActualizable
    {
        public FrmEstadoVehiculo()
        {
            InitializeComponent();
            this.Load += FrmEstadoVehiculo_Load;
        ...
        private void CargarDatosGrid()
        {
            try
            {
                var data = EstadoVehiculoBL.Instance.SelectAll();
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                bool ok = EstadoVehiculoBL.Instance.Insert(entity);
        ...
        private void btnActualizar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                EstadoVehiculo entity = new EstadoVehiculo
                {
                    EstadoVehiculoId = Convert.ToInt32(txtId.Text),
                    Nombre = txtNombre.Text.Trim()
                };

                bool ok = EstadoVehiculoBL.Instance.Update(entity);
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                bool ok = EstadoVehiculoBL.Instance.Delete(id);
